{
  ...
  '#':: d.pkg(name='xBackendTrafficPolicy', url='', help='"XBackendTrafficPolicy defines the configuration for how traffic to a\\ntarget backend should be handled."'),
  ...
  '#new':: d.fn(help='new returns an instance of XBackendTrafficPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#withTargetRefs':: d.fn(help='"TargetRefs identifies API object(s) to apply this policy to.\\nCurrently, Backends (A grouping of like endpoints such as Service,\\nServiceImport, or any implementation-specific backendRef) are the only\\nvalid API target references.\\n\\nCurrently, a TargetRef can not be scoped to a specific port on a\\nService."', args=[d.arg(name='targetRefs', type=d.T.array)]),
    withTargetRefs(targetRefs): { spec+: { targetRefs: if std.isArray(v=targetRefs) then targetRefs else [targetRefs] } },
    '#withTargetRefsMixin':: d.fn(help='"TargetRefs identifies API object(s) to apply this policy to.\\nCurrently, Backends (A grouping of like endpoints such as Service,\\nServiceImport, or any implementation-specific backendRef) are the only\\nvalid API target references.\\n\\nCurrently, a TargetRef can not be scoped to a specific port on a\\nService."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targetRefs', type=d.T.array)]),
