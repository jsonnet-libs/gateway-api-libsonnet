---
permalink: /1.4-experimental/gateway/v1beta1/gateway/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.allowedListeners`](#obj-specallowedlisteners)
    * [`obj spec.allowedListeners.namespaces`](#obj-specallowedlistenersnamespaces)
      * [`fn withFrom(from)`](#fn-specallowedlistenersnamespaceswithfrom)
      * [`obj spec.allowedListeners.namespaces.selector`](#obj-specallowedlistenersnamespacesselector)
        * [`fn withMatchExpressions(matchExpressions)`](#fn-specallowedlistenersnamespacesselectorwithmatchexpressions)
        * [`fn withMatchExpressionsMixin(matchExpressions)`](#fn-specallowedlistenersnamespacesselectorwithmatchexpressionsmixin)
        * [`fn withMatchLabels(matchLabels)`](#fn-specallowedlistenersnamespacesselectorwithmatchlabels)
        * [`fn withMatchLabelsMixin(matchLabels)`](#fn-specallowedlistenersnamespacesselectorwithmatchlabelsmixin)
        * [`obj spec.allowedListeners.namespaces.selector.matchExpressions`](#obj-specallowedlistenersnamespacesselectormatchexpressions)
          * [`fn withKey(key)`](#fn-specallowedlistenersnamespacesselectormatchexpressionswithkey)
          * [`fn withOperator(operator)`](#fn-specallowedlistenersnamespacesselectormatchexpressionswithoperator)
          * [`fn withValues(values)`](#fn-specallowedlistenersnamespacesselectormatchexpressionswithvalues)
          * [`fn withValuesMixin(values)`](#fn-specallowedlistenersnamespacesselectormatchexpressionswithvaluesmixin)
  ...
  * [`obj spec.tls`](#obj-spectls)
    * [`obj spec.tls.backend`](#obj-spectlsbackend)
      * [`obj spec.tls.backend.clientCertificateRef`](#obj-spectlsbackendclientcertificateref)
        * [`fn withGroup(group)`](#fn-spectlsbackendclientcertificaterefwithgroup)
        * [`fn withKind(kind)`](#fn-spectlsbackendclientcertificaterefwithkind)
        * [`fn withName(name)`](#fn-spectlsbackendclientcertificaterefwithname)
        * [`fn withNamespace(namespace)`](#fn-spectlsbackendclientcertificaterefwithnamespace)
    * [`obj spec.tls.frontend`](#obj-spectlsfrontend)
      * [`fn withPerPort(perPort)`](#fn-spectlsfrontendwithperport)
      * [`fn withPerPortMixin(perPort)`](#fn-spectlsfrontendwithperportmixin)
      * [`obj spec.tls.frontend.default`](#obj-spectlsfrontenddefault)
        * [`obj spec.tls.frontend.default.validation`](#obj-spectlsfrontenddefaultvalidation)
          * [`fn withCaCertificateRefs(caCertificateRefs)`](#fn-spectlsfrontenddefaultvalidationwithcacertificaterefs)
          * [`fn withCaCertificateRefsMixin(caCertificateRefs)`](#fn-spectlsfrontenddefaultvalidationwithcacertificaterefsmixin)
          * [`fn withMode(mode)`](#fn-spectlsfrontenddefaultvalidationwithmode)
          * [`obj spec.tls.frontend.default.validation.caCertificateRefs`](#obj-spectlsfrontenddefaultvalidationcacertificaterefs)
            * [`fn withGroup(group)`](#fn-spectlsfrontenddefaultvalidationcacertificaterefswithgroup)
            * [`fn withKind(kind)`](#fn-spectlsfrontenddefaultvalidationcacertificaterefswithkind)
            * [`fn withName(name)`](#fn-spectlsfrontenddefaultvalidationcacertificaterefswithname)
            * [`fn withNamespace(namespace)`](#fn-spectlsfrontenddefaultvalidationcacertificaterefswithnamespace)
      * [`obj spec.tls.frontend.perPort`](#obj-spectlsfrontendperport)
        * [`fn withPort(port)`](#fn-spectlsfrontendperportwithport)
        * [`obj spec.tls.frontend.perPort.tls`](#obj-spectlsfrontendperporttls)
          * [`obj spec.tls.frontend.perPort.tls.validation`](#obj-spectlsfrontendperporttlsvalidation)
            * [`fn withCaCertificateRefs(caCertificateRefs)`](#fn-spectlsfrontendperporttlsvalidationwithcacertificaterefs)
            * [`fn withCaCertificateRefsMixin(caCertificateRefs)`](#fn-spectlsfrontendperporttlsvalidationwithcacertificaterefsmixin)
            * [`fn withMode(mode)`](#fn-spectlsfrontendperporttlsvalidationwithmode)
            * [`obj spec.tls.frontend.perPort.tls.validation.caCertificateRefs`](#obj-spectlsfrontendperporttlsvalidationcacertificaterefs)
              * [`fn withGroup(group)`](#fn-spectlsfrontendperporttlsvalidationcacertificaterefswithgroup)
              * [`fn withKind(kind)`](#fn-spectlsfrontendperporttlsvalidationcacertificaterefswithkind)
              * [`fn withName(name)`](#fn-spectlsfrontendperporttlsvalidationcacertificaterefswithname)
              * [`fn withNamespace(namespace)`](#fn-spectlsfrontendperporttlsvalidationcacertificaterefswithnamespace)
