---
permalink: /1.4-experimental/gateway/v1alpha1/xBackendTrafficPolicy/
---

# gateway.v1alpha1.xBackendTrafficPolicy
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.retryConstraint`](#obj-specretryconstraint)
    * [`obj spec.retryConstraint.budget`](#obj-specretryconstraintbudget)
      * [`fn withInterval(interval)`](#fn-specretryconstraintbudgetwithinterval)
      * [`fn withPercent(percent)`](#fn-specretryconstraintbudgetwithpercent)
    * [`obj spec.retryConstraint.minRetryRate`](#obj-specretryconstraintminretryrate)
      * [`fn withCount(count)`](#fn-specretryconstraintminretryratewithcount)
      * [`fn withInterval(interval)`](#fn-specretryconstraintminretryratewithinterval)
